...
def Create_Frame(frame_id, matrix):
    ...
    for signal_name, signal_info in signals.items():
        ...
        if(CAN_Signals[signal_name] is None):
            return []
    ...
    while True:
        try:                       
            ...
            for frame_id, data in sendFrames.items():
                ...
                if(len(data) != 0):
                    send_message = can.Message(arbitration_id=frame_id, data=data, extended_id=False)
...
try:
    while True:
        ...
        CAN_Signals.update({
            "mc_VCU_OBCControl": 13,
            "VCU_OBCMode_Cmd": "charging",
            "VCU_uDcReqChrgr": 436.75,
            "VCU_iDcLimChrgr": -20.3,
            "VCU_iAcMaxAllwdChrgr": 15.8,
            "CRC_VCU_OBCControl": 69,
        })
